...
class contratController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $contrats = $em->getRepository('KEURGUIimmoBundle:contrat')->findAll();
    ...
    {
        $contrat = new Contrat();
        $form = $this->createForm('KEURGUI\immoBundle\Form\contratType', $contrat);
    ...
    {
        $deleteForm = $this->createDeleteForm($contrat);
        $editForm = $this->createForm('KEURGUI\immoBundle\Form\contratType', $contrat);
